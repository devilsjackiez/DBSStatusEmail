    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="panel">
                ...
                <div class="panel_content" align="center"
                     style="font-size: 60px"><?php echo round(($Unread5 / $Total5) * 100); ?><span
        ...
        <div class="col-md-2">
            <div class="panel">
                ...
                <br>
                <div class="panel_content" align="center"
                     style="font-size: 60px"><?php echo round(($Read5 / $Total5) * 100); ?><span style="font-size: 30px;"> %</span>
                </div>
            </div>
        </div>
        <div class="col-md-2">
            <div class="panel">
                ...
                <div class="panel_content" align="center" style="font-size: 60px"><span
                        style="font-weight: 800;font-size: 70px;"><?php echo round(($Replied5 / $Total5) * 100) . "</span>"; ?>
            ...
            <div class="panel">
                ...
                <div class="panel_content"
                     align="center" style="font-size: 60px"><span
                        style="font-weight: 800;font-size: 70px;"><?php echo round(($Total5 / $Total5) * 100) . "</span>"; ?>
                        <span style="font-size: 30px;"> %</span>
                </div>
            </div>
        </div>
