    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="panel">
                ...
                <div class="panel_content" align="center"><?php echo $Unread4; ?></div>
            </div>
        </div>
        <div class="col-md-2">
            <div class="panel">
                <div class="panel_header" align="center">Open</div>
                <div class="panel_content" align="center"><?php echo $Read4; ?></div>
            </div>
        </div>
        <div class="col-md-2">
            <div class="panel">
                <div class="panel_header" align="center">Replied</div>
                <div class="panel_content" align="center"><?php echo $Replied4; ?></div>
            </div>
        </div>
        <div class="col-md-2">
            <div class="panel">
                ...
                <div class="panel_content"
                     align="center"><?php echo $Total4; ?></div>
            </div>
        </div>
    </div>
</div>